            ...
            <main className="stc-addendum-article" tabIndex={-1}>
              <header className="stc-addendum-article-header">
                ...
                <div className="stc-addendum-meta-row">
                  ...
                  <span>•</span>
                  <span>{currentAddendum.partLabel ? `Companion · ${currentAddendum.partLabel}` : currentAddendum.partNumber === 0 ? 'Prologue · The Study Covenant' : `Part ${currentAddendum.partNumber} of 6`}</span>
                  <span>•</span>
