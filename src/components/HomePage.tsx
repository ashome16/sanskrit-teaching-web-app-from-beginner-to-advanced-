...
const CHAPTERS_INFO: ChapterInfo[] = [
  ...
  },
  {
    ...
    title: 'सम्यग्वर्णप्रयोगेण ब्रह्मलोके महीयते (Pages 137–144)',
    english: 'By Correct Pronunciation One Is Honoured in Brahmaloka',
    icon: '🗣️',
    category: 'grammar',
    genreBadge: 'शिक्षा · उच्चारण-शास्त्रम्',
    theme: 'पाणिनीय-शिक्षा: Indra–Vritrasura accent story, correct pronunciation, and the six qualities of an excellent reader.',
    grammarFocus: 'शिक्षा, स्वरपरिवर्तनम्, पदच्छेदः, वेदाङ्गानि',
  },
  {
    id: 'grade8_ch2',
