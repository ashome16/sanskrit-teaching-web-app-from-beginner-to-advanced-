  ...
  // ==========================================
  {
    ...
    sections: [
      ...
      },
      {
        ...
        subheading: 'Śaṅkara on the Triple Disturbance (Tāpatraya)',
        paragraphs: [
          ...
          'A guru does not only hand teaching. The guru opens a space in which teaching can land. That space is easily broken — by the student’s own agitation, by other people, by events no one controls.',
          'Traditional commentary on the triple śāntiḥ (Śaṅkara on the Taittirīya) names exactly those three disturbances:',
          '• Ādhyātmika (आध्यात्मिक) — from one’s own body and mind: fever, illness, wandering attention, doubt, emotional turbulence.',
          '• Ādhibhautika (आधिभौतिक) — from other beings and the world: fellow creatures, conflicts, social noise, family friction.',
          '• Ādhidaivika (आधिदैविक) — from forces beyond ordinary control: elemental storms, seismic disruptions, unforeseen environmental crises.',
        ...
        callout: {
          title: 'Never Begin Inside a Storm',
          text: '“The word śāntiḥ is said three times so the lesson is not asked to begin inside a storm. That is why it belongs at the start of a spiritual journey, not only at the end of a ritual.”',
          type: 'insight',
        },
      },
      {
    ...
    keyTakeaways: [
      ...
      'Śānti is śikṣā of the field: holding the room still just as śikṣā holds the articulated syllable still.',
      'The guru accepts responsibility aloud (avatu mām, avatu vaktāram)—entering the same protection and vow, not acting as a content dispenser.',
      'Embarking requires four anchors: a field (three śāntiḥ), a bond (saha), a duty (adhikāra), and a refusal of harm (mā vidviṣāvahai).',
    ],
  },
